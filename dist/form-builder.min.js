...
angular.module('mwFormBuilder').directive('mwQuestionOfferedAnswerListBuilder', function () {
    ...
    return {
        ...
        controllerAs: 'ctrl',
        bindToController: true,
        controller: ["FormQuestionBuilderId", "uuid", function(FormQuestionBuilderId, uuid){
            var ctrl = this;
            ctrl.config={
                radio:{
...
angular.module('mwFormBuilder').factory("FormQuestionBuilderId", function(){
    ...
    return {
        ...
        controllerAs: 'ctrl',
        bindToController: true,
        controller: ["$timeout", "FormQuestionBuilderId", "uuid", function($timeout,FormQuestionBuilderId, uuid){
            var ctrl = this;
...
angular.module('mwFormBuilder').directive('mwFormPageBuilder', function () {
    ...
    return {
        ...
        controllerAs: 'ctrl',
        bindToController: true,
        controller: ["$timeout", "uuid", function($timeout, uuid){
            var ctrl = this;
...
angular.module('mwFormBuilder').factory("FormImageBuilderId", function(){
    ...
    return {
        ...
        controllerAs: 'ctrl',
        bindToController: true,
        controller: ["$timeout", "FormImageBuilderId", "uuid", function($timeout,FormImageBuilderId, uuid){
            var ctrl = this;
