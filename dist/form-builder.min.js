...
$templateCache.put("mw-label.html","<label ng-attr-for={{::ctrl.labelFor}} ng-attr-class={{::ctrl.labelClass}}>{{ctrl.labelKey|translate:ctrl.labelTranslateValues}}</label>");
...
angular.module('mwFormBuilder').directive('mwFormPageBuilder', function () {
    ...
    return {
        ...
        controllerAs: 'ctrl',
        bindToController: true,
        controller: ["$timeout", "mwFormUuid", "mwFormClone", function($timeout, mwFormUuid, mwFormClone){
            var ctrl = this;
