...
angular.module("mwFormBuilder").factory("FormQuestionBuilderId",function(){var e=0;return{next:function(){return++e}}}).directive("mwFormQuestionBuilder",function(){return{replace:!0,restrict:"AE",require:"^mwFormPageElementBuilder",scope:{question:"=",formObject:"=",onReady:"&",isPreview:"=?",readOnly:"=?"},templateUrl:"mw-form-question-builder.html",controllerAs:"ctrl",bindToController:!0,controller:["$timeout","FormQuestionBuilderId","mwFormBuilderOptions",function(e,o,n){function t(){var e=[];return u.formObject.pages.forEach(function(o){o.elements.filter(function(e){return"question"===e.type&&"radio"===e.question.type}).forEach(function(o){e.push(o.question)})}),e}function r(){if(u.question.offeredAnswers)for(var e=0;e<u.question.offeredAnswers.length;e++)u.question.offeredAnswers[e].orderNo=e+1}function i(){u.question.offeredAnswers&&u.question.offeredAnswers.sort(function(e,o){return e.orderNo-o.orderNo})}function s(){u.question.offeredAnswers&&u.question.offeredAnswers.forEach(function(e){u.question.pageFlowModifier?e.pageFlow=u.possiblePageFlow[0]:delete e.pageFlow})}var u=this;u.id=o.next(),u.questionTypes=n.questionTypes,u.formSubmitted=!1,u.toggleVisibleIf=function(){u.radioQuestions=t()},i(),u.save=function(){u.formSubmitted=!0,u.form.$valid&&u.onReady()},u.offeredAnswersSortableConfig={disabled:u.readOnly,ghostClass:"beingDragged",handle:".drag-handle",onEnd:function(e,o){r()}},u.questionTypeChanged=function(){"radio"!=u.question.type&&"checkbox"!=u.question.type||u.question.offeredAnswers||(u.question.offeredAnswers=[]),"radio"!=u.question.type&&(s(),e(function(){u.question.pageFlowModifier=!1})),"radio"!=u.question.type&&"checkbox"!=u.question.type&&delete u.question.offeredAnswers,"grid"!=u.question.type&&delete u.question.grid,"priority"!=u.question.type&&delete u.question.priorityList},u.pageFlowModifierChanged=function(){s()}}],link:function(e,o,n,t){var r=e.ctrl;r.possiblePageFlow=t.possiblePageFlow,r.options=t.options}}});
...
angular.module("mwFormBuilder").directive("mwFormPageElementBuilder",function(){return{replace:!0,restrict:"AE",require:"^mwFormPageBuilder",scope:{pageElement:"=",formObject:"=",isActive:"=",isFirst:"=",isLast:"=",onReady:"&",readOnly:"=?"},templateUrl:"mw-form-page-element-builder.html",controllerAs:"ctrl",bindToController:!0,controller:["mwFormUuid",function(e){var t=this;t.callback=function(e,n){e.preventDefault(),e.stopPropagation(),n.callback&&"function"==typeof n.callback&&n.callback(t.pageElement)},t.filter=function(e){return e.filter&&"function"==typeof e.filter?e.filter(t.pageElement):!0},"question"==t.pageElement.type?t.pageElement.question||(t.pageElement.question={id:e.get(),text:null,type:null,required:!0}):"image"==t.pageElement.type?t.pageElement.image||(t.pageElement.image={id:e.get(),align:"left"}):"paragraph"==t.pageElement.type&&(t.pageElement.paragraph||(t.pageElement.paragraph={id:e.get(),html:""}))}],link:function(e,t,n,l){var o=e.ctrl;o.possiblePageFlow=l.possiblePageFlow,o.hoverIn=function(){o.isHovered=!0},o.hoverOut=function(){o.isHovered=!1},o.editElement=function(){l.selectElement(o.pageElement)},o.cloneElement=function(e){e.preventDefault(),e.stopPropagation(),l.cloneElement(o.pageElement)},o.removeElement=function(){l.removeElement(o.pageElement)},o.moveDown=function(){l.moveDownElement(o.pageElement)},o.moveUp=function(){l.moveUpElement(o.pageElement)},o.options=l.options,o.onImageSelection=l.onImageSelection}}});
...
angular.module("mwFormBuilder").directive("mwFormBuilder",function(){return{replace:!0,restrict:"AE",scope:{formData:"=",readOnly:"=?",options:"=?",formStatus:"=?",onImageSelection:"&",api:"=?"},templateUrl:"mw-form-builder.html",controllerAs:"ctrl",bindToController:!0,controller:["mwFormUuid","MW_QUESTION_TYPES","mwFormBuilderOptions",function(e,a,o){function t(a){var o=null;return s.possiblePageFlow&&(o=s.possiblePageFlow[0]),{id:e.get(),number:a,name:null,description:null,pageFlow:o,elements:[]}}function n(){for(var e=0;e<s.formData.pages.length;e++)s.formData.pages[e].number=e+1;s.updatePageFlow()}function r(e,a,o){var t=e[a];e.splice(a,1),e.splice(o,0,t)}var s=this;s.formData.pages&&s.formData.pages.length||(s.formData.pages=[],s.formData.pages.push(t(1))),o.questionTypes=a,o.elementButtons=[],o.additionalSelects=[],s.options&&(s.options.questionTypes&&(o.questionTypes=s.options.questionTypes),s.options.additionalSelects&&(o.additionalSelects=s.options.additionalSelects),s.options.elementButtons&&(o.elementButtons=s.options.elementButtons)),s.addPage=function(){s.formData.pages.push(t(s.formData.pages.length+1))},s.addPageAfter=function(e){var a=s.formData.pages.indexOf(e),o=a+1,r=t(e.number+1);o<s.formData.pages.length?s.formData.pages.splice(o,0,r):s.formData.pages.push(r),n()},s.moveDownPage=function(e){var a=s.formData.pages.indexOf(e),o=a+1;o<s.formData.pages.length&&r(s.formData.pages,a,o),n()},s.moveUpPage=function(e){var a=s.formData.pages.indexOf(e),o=a-1;o>=0&&r(s.formData.pages,a,o),n()},s.removePage=function(e){var a=s.formData.pages.indexOf(e);s.formData.pages.splice(a,1),n()},s.api&&(s.api.reset=function(){for(var e in s.formData)s.formData.hasOwnProperty(e)&&"pages"!=e&&delete s.formData[e];s.formData.pages.length=0,s.formData.pages.push(t(1))})}],link:function(e,a,o){var t=e.ctrl;t.formStatus&&(t.formStatus.form=t.form),t.possiblePageFlow=[];var n={nextPage:!0,label:"mwForm.pageFlow.goToNextPage"};t.possiblePageFlow.push(n),t.isSamePageFlow=function(e,a){return e.page&&a.page&&e.page.id==a.page.id||e.formSubmit&&a.formSubmit||e.nextPage&&a.nextPage},t.updatePageFlow=function(){t.possiblePageFlow.length=1,t.formData.pages.forEach(function(e){t.possiblePageFlow.push({page:{id:e.id,number:e.number},label:"mwForm.pageFlow.goToPage"})}),t.possiblePageFlow.push({formSubmit:!0,label:"mwForm.pageFlow.submitForm"}),t.formData.pages.forEach(function(e){t.possiblePageFlow.forEach(function(a){e.pageFlow?t.isSamePageFlow(a,e.pageFlow)&&(e.pageFlow=a):e.pageFlow=n,e.elements.forEach(function(e){var o=e.question;o&&o.pageFlowModifier&&o.offeredAnswers.forEach(function(e){e.pageFlow&&t.isSamePageFlow(a,e.pageFlow)&&(e.pageFlow=a)})})})})},e.$watch("ctrl.formData.pages.length",function(e,a){t.updatePageFlow()})}}});
