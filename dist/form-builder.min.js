...
angular.module("mwFormBuilder").factory("FormQuestionBuilderId",function(){var e=0;return{next:function(){return++e}}}).directive("mwFormQuestionBuilder",function(){return{replace:!0,restrict:"AE",require:"^mwFormPageElementBuilder",scope:{question:"=",formObject:"=",onReady:"&",isPreview:"=?",readOnly:"=?",options:"=?"},templateUrl:"mw-form-question-builder.html",controllerAs:"ctrl",bindToController:!0,controller:["$timeout","FormQuestionBuilderId","uuid",function(e,o,r){function i(){if(s.question.offeredAnswers)for(var e=0;e<s.question.offeredAnswers.length;e++)s.question.offeredAnswers[e].orderNo=e+1}function n(){s.question.offeredAnswers&&s.question.offeredAnswers.sort(function(e,o){return e.orderNo-o.orderNo})}function t(){s.question.offeredAnswers&&s.question.offeredAnswers.forEach(function(e){s.question.pageFlowModifier?e.pageFlow=s.possiblePageFlow[0]:delete e.pageFlow})}var s=this;s.id=o.next(),s.questionTypes=["text","textarea","radio","checkbox","grid","priority","division"],s.formSubmitted=!1,n(),s.save=function(){s.formSubmitted=!0,s.form.$valid&&s.onReady()},s.offeredAnswersSortableConfig={placeholder:"beingDragged",handle:".drag-handle",stop:function(e,o){i()}},s.questionTypeChanged=function(){("radio"==s.question.type||"checkbox"==s.question.type)&&(s.question.offeredAnswers||(s.question.offeredAnswers=[])),"radio"!=s.question.type&&(t(),e(function(){s.question.pageFlowModifier=!1})),"radio"!=s.question.type&&"checkbox"!=s.question.type&&delete s.question.offeredAnswers,"grid"!=s.question.type&&delete s.question.grid,"priority"!=s.question.type&&delete s.question.priorityList},s.pageFlowModifierChanged=function(){t()}}],link:function(e,o,r,i){var n=e.ctrl;n.possiblePageFlow=i.possiblePageFlow}}});
...
angular.module("mwFormBuilder").directive("mwFormBuilder",function(){return{replace:!0,restrict:"AE",scope:{formData:"=",readOnly:"=?",options:"=?",formStatus:"=?",confirm:"=",onImageSelection:"&"},templateUrl:"mw-form-builder.html",controllerAs:"ctrl",bindToController:!0,controller:["uuid",function(a){function e(e){var o=t.possiblePageFlow[0];return{id:a.get(),number:e,name:null,description:null,pageFlow:o,elements:[]}}function o(){for(var a=0;a<t.formData.pages.length;a++)t.formData.pages[a].number=a+1;t.updatePageFlow()}function r(a,e,o){var r=a[e];a.splice(e,1),a.splice(o,0,r)}var t=this;t.translations={},t.formData.pages&&t.formData.pages.length||(t.formData.pages=[],t.formData.pages.push(e(1))),console.log(t.formData),t.addPage=function(){t.formData.pages.push(e(t.formData.pages.length+1))},t.addPageAfter=function(a){var r=t.formData.pages.indexOf(a),n=r+1,l=e(a.number+1);n<t.formData.pages.length?t.formData.pages.splice(n,0,l):t.formData.pages.push(l),o()},t.moveDownPage=function(a){var e=t.formData.pages.indexOf(a),n=e+1;n<t.formData.pages.length&&r(t.formData.pages,e,n),o()},t.moveUpPage=function(a){var e=t.formData.pages.indexOf(a),n=e-1;n>=0&&r(t.formData.pages,e,n),o()},t.removePage=function(a){var e=t.formData.pages.indexOf(a);t.formData.pages.splice(e,1),o()}}],link:function(a,e,o){var r=a.ctrl;r.formStatus.form=r.form,r.possiblePageFlow=[];var t={nextPage:!0,label:"mwForm.pageFlow.goToNextPage"};r.possiblePageFlow.push(t),r.isSamePageFlow=function(a,e){return a.page&&e.page&&a.page.id==e.page.id||a.formSubmit&&e.formSubmit||a.nextPage&&e.nextPage},r.updatePageFlow=function(){r.possiblePageFlow.length=1,r.formData.pages.forEach(function(a){r.possiblePageFlow.push({page:{id:a.id,number:a.number},label:"mwForm.pageFlow.goToPage"})}),r.possiblePageFlow.push({formSubmit:!0,label:"mwForm.pageFlow.submitForm"}),r.formData.pages.forEach(function(a){r.possiblePageFlow.forEach(function(e){a.pageFlow?r.isSamePageFlow(e,a.pageFlow)&&(a.pageFlow=e):a.pageFlow=t,a.elements.forEach(function(a){var o=a.question;o&&o.pageFlowModifier&&o.offeredAnswers.forEach(function(a){a.pageFlow&&r.isSamePageFlow(e,a.pageFlow)&&(a.pageFlow=e)})})})})},a.$watch("ctrl.formData.pages.length",function(a,e){r.updatePageFlow()})}}});
