...
angular.module("mwFormBuilder").factory("FormQuestionBuilderId",function(){var e=0;return{next:function(){return++e}}}).directive("mwFormQuestionBuilder",function(){return{replace:!0,restrict:"AE",require:"^mwFormPageElementBuilder",scope:{question:"=",formObject:"=",onReady:"&",isPreview:"=?",readOnly:"=?"},templateUrl:"mw-form-question-builder.html",controllerAs:"ctrl",bindToController:!0,controller:["$timeout","FormQuestionBuilderId","mwFormBuilderOptions","$scope",function(e,o,n,t){function r(){var e=[];return f.formObject.pages.forEach(function(o){o.elements.filter(function(e){return"question"===e.type&&"radio"===e.question.type}).forEach(function(o){e.push(o.question)})}),e}function i(){if(f.question.offeredAnswers)for(var e=0;e<f.question.offeredAnswers.length;e++)f.question.offeredAnswers[e].orderNo=e+1}function s(){f.question.offeredAnswers&&f.question.offeredAnswers.sort(function(e,o){return e.orderNo-o.orderNo})}function u(){f.question.offeredAnswers&&f.question.offeredAnswers.forEach(function(e){f.question.pageFlowModifier?e.pageFlow=f.possiblePageFlow[0]:delete e.pageFlow})}var f=this;f.id=o.next(),f.questionTypes=n.questionTypes,f.formSubmitted=!1,t.$watchCollection("ctrl.formObject.pages",function(e){e.forEach(function(e){t.$watchCollection(function(){return e.elements},function(e){e&&e.forEach(function(e){t.$watch(function(){return e},function(e){f.radioQuestions=r()},!0)})},!0)})},!0),s(),f.save=function(){f.formSubmitted=!0,f.form.$valid&&f.onReady()},f.offeredAnswersSortableConfig={disabled:f.readOnly,ghostClass:"beingDragged",handle:".drag-handle",onEnd:function(e,o){i()}},f.questionTypeChanged=function(){"radio"!=f.question.type&&"checkbox"!=f.question.type||f.question.offeredAnswers||(f.question.offeredAnswers=[]),"radio"!=f.question.type&&(u(),e(function(){f.question.pageFlowModifier=!1})),"radio"!=f.question.type&&"checkbox"!=f.question.type&&delete f.question.offeredAnswers,"grid"!=f.question.type&&delete f.question.grid,"priority"!=f.question.type&&delete f.question.priorityList},f.pageFlowModifierChanged=function(){u()}}],link:function(e,o,n,t){var r=e.ctrl;r.possiblePageFlow=t.possiblePageFlow,r.options=t.options}}});
