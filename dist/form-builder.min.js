...
angular.module("mwFormBuilder").service("mwFormUuid",function(){function e(){return Math.floor(65536*(1+Math.random())).toString(16).substring(1)}this.get=function(){return e()+e()+e()+e()+e()+e()+e()+e()}}).factory("mwFormClone",["mwFormUuid","$log",function(e,r){function n(r,a){if(a&&(o=[]),!(o.indexOf(r)>=0)&&(o.push(r),!r!==Object(r))){if(Array.isArray(r))return void r.forEach(n);for(var t in r)r.hasOwnProperty(t)&&n(r[t]);if(r.hasOwnProperty("id")){var i=e.get();r.id;r.id=i}}}var a={},o=[];return a.cloneElement=function(e){var r={};return angular.copy(e,r),n(r,!0),r},a.clonePage=function(n){var o={};angular.copy(n,o),o.id=e.get();var t=[];if(Array.isArray(n.elements))for(var i=0;i<n.elements.length;i++)r.info("element> ",i),r.info("element value> ",n.elements[i]),t.push(a.cloneElement(n.elements[i]));return o.elements=t,o},a.cloneForm=function(e){var n={};angular.copy(e,n);var o=[];if(Array.isArray(e.pages))for(var t=0;t<e.pages.length;t++)r.info("page> ",t),r.info("page value> ",e.pages[t]),o.push(a.clonePage(e.pages[t]));return n.pages=o,n},a}]);
