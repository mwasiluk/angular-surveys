angular.module("mwFormBuilder",["ngSanitize","ui.sortable","pascalprecht.translate"]).constant("MW_QUESTION_TYPES",["text","textarea","radio","checkbox","grid","priority","division","number","date","time","email","range","url"]).value("mwFormBuilderOptions",{});
...
angular.module("mwFormBuilder").factory("FormQuestionBuilderId",function(){var e=0;return{next:function(){return++e}}}).directive("mwFormQuestionBuilder",function(){return{replace:!0,restrict:"AE",require:"^mwFormPageElementBuilder",scope:{question:"=",formObject:"=",onReady:"&",isPreview:"=?",readOnly:"=?"},templateUrl:"mw-form-question-builder.html",controllerAs:"ctrl",bindToController:!0,controller:["$timeout","FormQuestionBuilderId","mwFormBuilderOptions",function(e,o,r){function n(){if(s.question.offeredAnswers)for(var e=0;e<s.question.offeredAnswers.length;e++)s.question.offeredAnswers[e].orderNo=e+1}function t(){s.question.offeredAnswers&&s.question.offeredAnswers.sort(function(e,o){return e.orderNo-o.orderNo})}function i(){s.question.offeredAnswers&&s.question.offeredAnswers.forEach(function(e){s.question.pageFlowModifier?e.pageFlow=s.possiblePageFlow[0]:delete e.pageFlow})}var s=this;s.id=o.next(),s.questionTypes=r.questionTypes,s.formSubmitted=!1,t(),s.save=function(){s.formSubmitted=!0,s.form.$valid&&s.onReady()},s.offeredAnswersSortableConfig={disabled:s.readOnly,placeholder:"beingDragged",handle:".drag-handle",stop:function(e,o){n()}},s.questionTypeChanged=function(){("radio"==s.question.type||"checkbox"==s.question.type)&&(s.question.offeredAnswers||(s.question.offeredAnswers=[])),"radio"!=s.question.type&&(i(),e(function(){s.question.pageFlowModifier=!1})),"radio"!=s.question.type&&"checkbox"!=s.question.type&&delete s.question.offeredAnswers,"grid"!=s.question.type&&delete s.question.grid,"priority"!=s.question.type&&delete s.question.priorityList},s.pageFlowModifierChanged=function(){i()}}],link:function(e,o,r,n){var t=e.ctrl;t.possiblePageFlow=n.possiblePageFlow}}});
...
angular.module("mwFormBuilder").directive("mwFormPageBuilder",function(){return{replace:!0,restrict:"AE",require:"^mwFormBuilder",scope:{formPage:"=",formObject:"=",isFirst:"=",isLast:"=",readOnly:"=?"},templateUrl:"mw-form-page-builder.html",controllerAs:"ctrl",bindToController:!0,controller:["$timeout","mwFormUuid",function(e,n){function o(){for(var e=0;e<l.formPage.elements.length;e++)l.formPage.elements[e].orderNo=e+1}function t(){l.formPage.elements.sort(function(e,n){return e.orderNo-n.orderNo})}function r(e,o){if(o&&(m=[]),!(m.indexOf(e)>=0)&&(m.push(e),!e!==Object(e))){if(Array.isArray(e))return void e.forEach(r);for(var t in e)e.hasOwnProperty(t)&&r(e[t]);if(e.hasOwnProperty("id")){var a=n.get(),i=e.id;void 0,e.id=a}}}function a(e,o){return{id:n.get(),orderNo:o,type:e}}function i(e,n,o){var t=e[n];e.splice(n,1),e.splice(o,0,t)}var l=this;l.hoverEdit=!1,l.formPage.namedPage=!!l.formPage.name,l.isFolded=!1,l.unfold=function(){l.isFolded=!1},l.fold=function(){l.isFolded=!0},t(),l.sortableConfig={disabled:l.readOnly,placeholder:"beingDragged",handle:".inactive",connectWith:".page-element-list",stop:function(e,n){o()}},l.activeElement=null,l.addElement=function(e){e||(e="question");var n=a(e,l.formPage.elements.length+1);l.activeElement=n,l.formPage.elements.push(n)},l.cloneElement=function(e,n){var o=l.formPage.elements.indexOf(e),t={};angular.copy(e,t),n&&(l.activeElement=t),r(t,!0),l.formPage.elements.splice(o,0,t)};var m=[];l.removeElement=function(e){var n=l.formPage.elements.indexOf(e);l.formPage.elements.splice(n,1)},l.moveDownElement=function(e){var n=l.formPage.elements.indexOf(e),t=n+1;t<l.formPage.elements.length&&i(l.formPage.elements,n,t),o()},l.moveUpElement=function(e){var n=l.formPage.elements.indexOf(e),t=n-1;t>=0&&i(l.formPage.elements,n,t),o()},l.addQuestion=function(){l.addElement("question")},l.addImage=function(){l.addElement("image")},l.addParagraph=function(){l.addElement("paragraph")},l.isElementActive=function(e){return l.activeElement==e},l.selectElement=function(e){l.activeElement=e},l.onElementReady=function(){e(function(){l.activeElement=null})},l.hoverIn=function(){l.hoverEdit=!0},l.hoverOut=function(){l.hoverEdit=!1},l.updateElementsOrderNo=o}],link:function(e,n,o,t){var r=e.ctrl;r.possiblePageFlow=t.possiblePageFlow,r.moveDown=function(){t.moveDownPage(r.formPage)},r.moveUp=function(){t.moveUpPage(r.formPage)},r.removePage=function(){t.removePage(r.formPage)},r.addPage=function(){t.addPageAfter(r.formPage)},e.$watch("ctrl.formPage.elements.length",function(e,n){e!=n&&r.updateElementsOrderNo()}),r.onImageSelection=t.onImageSelection}}});
...
angular.module("mwFormBuilder").directive("mwFormBuilder",function(){return{replace:!0,restrict:"AE",scope:{formData:"=",readOnly:"=?",options:"=?",formStatus:"=?",onImageSelection:"&",api:"=?"},templateUrl:"mw-form-builder.html",controllerAs:"ctrl",bindToController:!0,controller:["mwFormUuid","MW_QUESTION_TYPES","mwFormBuilderOptions",function(a,e,o){function t(e){var o=null;return s.possiblePageFlow&&(o=s.possiblePageFlow[0]),{id:a.get(),number:e,name:null,description:null,pageFlow:o,elements:[]}}function r(){for(var a=0;a<s.formData.pages.length;a++)s.formData.pages[a].number=a+1;s.updatePageFlow()}function n(a,e,o){var t=a[e];a.splice(e,1),a.splice(o,0,t)}var s=this;s.formData.pages&&s.formData.pages.length||(s.formData.pages=[],s.formData.pages.push(t(1))),o.questionTypes=e,s.options&&s.options.questionTypes&&(o.questionTypes=s.options.questionTypes),s.addPage=function(){s.formData.pages.push(t(s.formData.pages.length+1))},s.addPageAfter=function(a){var e=s.formData.pages.indexOf(a),o=e+1,n=t(a.number+1);o<s.formData.pages.length?s.formData.pages.splice(o,0,n):s.formData.pages.push(n),r()},s.moveDownPage=function(a){var e=s.formData.pages.indexOf(a),o=e+1;o<s.formData.pages.length&&n(s.formData.pages,e,o),r()},s.moveUpPage=function(a){var e=s.formData.pages.indexOf(a),o=e-1;o>=0&&n(s.formData.pages,e,o),r()},s.removePage=function(a){var e=s.formData.pages.indexOf(a);s.formData.pages.splice(e,1),r()},s.api&&(s.api.reset=function(){for(var a in s.formData)s.formData.hasOwnProperty(a)&&"pages"!=a&&delete s.formData[a];s.formData.pages.length=0,s.formData.pages.push(t(1))})}],link:function(a,e,o){var t=a.ctrl;t.formStatus&&(t.formStatus.form=t.form),t.possiblePageFlow=[];var r={nextPage:!0,label:"mwForm.pageFlow.goToNextPage"};t.possiblePageFlow.push(r),t.isSamePageFlow=function(a,e){return a.page&&e.page&&a.page.id==e.page.id||a.formSubmit&&e.formSubmit||a.nextPage&&e.nextPage},t.updatePageFlow=function(){t.possiblePageFlow.length=1,t.formData.pages.forEach(function(a){t.possiblePageFlow.push({page:{id:a.id,number:a.number},label:"mwForm.pageFlow.goToPage"})}),t.possiblePageFlow.push({formSubmit:!0,label:"mwForm.pageFlow.submitForm"}),t.formData.pages.forEach(function(a){t.possiblePageFlow.forEach(function(e){a.pageFlow?t.isSamePageFlow(e,a.pageFlow)&&(a.pageFlow=e):a.pageFlow=r,a.elements.forEach(function(a){var o=a.question;o&&o.pageFlowModifier&&o.offeredAnswers.forEach(function(a){a.pageFlow&&t.isSamePageFlow(e,a.pageFlow)&&(a.pageFlow=e)})})})})},a.$watch("ctrl.formData.pages.length",function(a,e){t.updatePageFlow()})}}});
