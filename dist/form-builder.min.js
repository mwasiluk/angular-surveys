...
angular.module("mwFormBuilder").service("mwFormUuid",function(){function r(){return Math.floor(65536*(1+Math.random())).toString(16).substring(1)}this.get=function(){return r()+r()+r()+r()+r()+r()+r()+r()}}).factory("mwFormClone",["mwFormUuid",function(r){function n(t,e){if(e&&(o=[]),!(o.indexOf(t)>=0)&&(o.push(t),!t!==Object(t))){if(Array.isArray(t))return void t.forEach(n);for(var i in t)t.hasOwnProperty(i)&&n(t[i]);if(t.hasOwnProperty("id")){var u=r.get();t.id;t.id=u}}}var t={},o=[];return t.cloneElement=function(r){var t={};return angular.copy(r,t),n(t,!0),t},t.cloneElements=function(r){var n=[];if(Array.isArray(r))for(var o=0;o<r.length;o++)n.push(t.cloneElement(r[o]));return n},t}]);
