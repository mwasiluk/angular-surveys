...
angular.module("mwFormBuilder").directive("mwFormPageBuilder",function(){return{replace:!0,restrict:"AE",require:"^mwFormBuilder",scope:{formPage:"=",formObject:"=",isFirst:"=",isLast:"=",readOnly:"=?",options:"=?"},templateUrl:"mw-form-page-builder.html",controllerAs:"ctrl",bindToController:!0,controller:["$timeout","mwFormUuid",function(e,n){function o(){for(var e=0;e<m.formPage.elements.length;e++)m.formPage.elements[e].orderNo=e+1}function t(){m.formPage.elements.sort(function(e,n){return e.orderNo-n.orderNo})}function r(e,o){return{id:n.get(),orderNo:o,type:e}}function a(e,n,o){var t=e[n];e.splice(n,1),e.splice(o,0,t)}var m=this;m.hoverEdit=!1,m.formPage.namedPage=!!m.formPage.name,m.isFolded=!1,m.unfold=function(){m.isFolded=!1},m.fold=function(){m.isFolded=!0},t(),m.sortableConfig={placeholder:"beingDragged",handle:".inactive",connectWith:".page-element-list",stop:function(e,n){o()}},m.activeElement=null,m.addElement=function(e){e||(e="question");var n=r(e,m.formPage.elements.length+1);m.activeElement=n,m.formPage.elements.push(n)},m.removeElement=function(e){var n=m.formPage.elements.indexOf(e);m.formPage.elements.splice(n,1)},m.moveDownElement=function(e){var n=m.formPage.elements.indexOf(e),t=n+1;t<m.formPage.elements.length&&a(m.formPage.elements,n,t),o()},m.moveUpElement=function(e){var n=m.formPage.elements.indexOf(e),t=n-1;t>=0&&a(m.formPage.elements,n,t),o()},m.addQuestion=function(){m.addElement("question")},m.addImage=function(){m.addElement("image")},m.addParagraph=function(){m.addElement("paragraph")},m.isElementActive=function(e){return m.activeElement==e},m.selectElement=function(e){m.activeElement=e},m.onElementReady=function(){e(function(){m.activeElement=null})},m.hoverIn=function(){m.hoverEdit=!0},m.hoverOut=function(){m.hoverEdit=!1},m.updateElementsOrderNo=o}],link:function(e,n,o,t){var r=e.ctrl;r.possiblePageFlow=t.possiblePageFlow,r.moveDown=function(){t.moveDownPage(r.formPage)},r.moveUp=function(){t.moveUpPage(r.formPage)},r.removePage=function(){t.removePage(r.formPage)},r.addPage=function(){t.addPageAfter(r.formPage)},e.$watch("ctrl.formPage.elements.length",function(e,n){e!=n&&r.updateElementsOrderNo()}),r.onImageSelection=t.onImageSelection}}});
