...
angular.module("mwFormBuilder").directive("mwFormBuilder",function(){return{replace:!0,restrict:"AE",scope:{formData:"=",readOnly:"=?",options:"=?",formStatus:"=?",onImageSelection:"&",api:"=?"},templateUrl:"mw-form-builder.html",controllerAs:"ctrl",bindToController:!0,controller:["mwFormUuid","MW_QUESTION_TYPES","mwFormBuilderOptions",function(e,a,o){function t(a){var o=null;return l.possiblePageFlow&&(o=l.possiblePageFlow[0]),{id:e.get(),number:a,name:null,description:null,pageFlow:o,elements:[]}}function r(){for(var e=0;e<l.formData.pages.length;e++)l.formData.pages[e].number=e+1;l.updatePageFlow()}function n(e,a,o){var t=e[a];e.splice(a,1),e.splice(o,0,t)}var l=this;l.formData.pages&&l.formData.pages.length||(l.formData.pages=[],l.formData.pages.push(t(1))),o.questionTypes=a,o.elementButtons=[],o.additionalSelects=[],l.options&&(l.options.questionTypes&&(o.questionTypes=l.options.questionTypes),l.options.additionalSelects&&(o.additionalSelects=l.options.additionalSelects)),l.addPage=function(){l.formData.pages.push(t(l.formData.pages.length+1))},l.addPageAfter=function(e){var a=l.formData.pages.indexOf(e),o=a+1,n=t(e.number+1);o<l.formData.pages.length?l.formData.pages.splice(o,0,n):l.formData.pages.push(n),r()},l.moveDownPage=function(e){var a=l.formData.pages.indexOf(e),o=a+1;o<l.formData.pages.length&&n(l.formData.pages,a,o),r()},l.moveUpPage=function(e){var a=l.formData.pages.indexOf(e),o=a-1;o>=0&&n(l.formData.pages,a,o),r()},l.removePage=function(e){var a=l.formData.pages.indexOf(e);l.formData.pages.splice(a,1),r()},l.api&&(l.api.reset=function(){for(var e in l.formData)l.formData.hasOwnProperty(e)&&"pages"!=e&&delete l.formData[e];l.formData.pages.length=0,l.formData.pages.push(t(1))})}],link:function(e,a,o){var t=e.ctrl;t.formStatus&&(t.formStatus.form=t.form),t.possiblePageFlow=[];var r={nextPage:!0,label:"mwForm.pageFlow.goToNextPage"};t.possiblePageFlow.push(r),t.isSamePageFlow=function(e,a){return e.page&&a.page&&e.page.id==a.page.id||e.formSubmit&&a.formSubmit||e.nextPage&&a.nextPage},t.updatePageFlow=function(){t.possiblePageFlow.length=1,t.formData.pages.forEach(function(e){t.possiblePageFlow.push({page:{id:e.id,number:e.number},label:"mwForm.pageFlow.goToPage"})}),t.possiblePageFlow.push({formSubmit:!0,label:"mwForm.pageFlow.submitForm"}),t.formData.pages.forEach(function(e){t.possiblePageFlow.forEach(function(a){e.pageFlow?t.isSamePageFlow(a,e.pageFlow)&&(e.pageFlow=a):e.pageFlow=r,e.elements.forEach(function(e){var o=e.question;o&&o.pageFlowModifier&&o.offeredAnswers.forEach(function(e){e.pageFlow&&t.isSamePageFlow(a,e.pageFlow)&&(e.pageFlow=a)})})})})},e.$watch("ctrl.formData.pages.length",function(e,a){t.updatePageFlow()})}}});
