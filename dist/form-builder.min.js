...
angular.module("mwFormBuilder").factory("FormQuestionBuilderId",function(){var e=0;return{next:function(){return++e}}}).directive("mwFormQuestionBuilder",function(){return{replace:!0,restrict:"AE",require:"^mwFormPageElementBuilder",scope:{question:"=",formObject:"=",onReady:"&",isPreview:"=?",readOnly:"=?",options:"=?"},templateUrl:"mw-form-question-builder.html",controllerAs:"ctrl",bindToController:!0,controller:["$timeout","FormQuestionBuilderId",function(e,o){function r(){if(t.question.offeredAnswers)for(var e=0;e<t.question.offeredAnswers.length;e++)t.question.offeredAnswers[e].orderNo=e+1}function n(){t.question.offeredAnswers&&t.question.offeredAnswers.sort(function(e,o){return e.orderNo-o.orderNo})}function i(){t.question.offeredAnswers&&t.question.offeredAnswers.forEach(function(e){t.question.pageFlowModifier?e.pageFlow=t.possiblePageFlow[0]:delete e.pageFlow})}var t=this;t.id=o.next(),t.questionTypes=["text","textarea","radio","checkbox","grid","priority","division"],t.formSubmitted=!1,n(),t.save=function(){t.formSubmitted=!0,t.form.$valid&&t.onReady()},t.offeredAnswersSortableConfig={disabled:t.readOnly,placeholder:"beingDragged",handle:".drag-handle",stop:function(e,o){r()}},t.questionTypeChanged=function(){("radio"==t.question.type||"checkbox"==t.question.type)&&(t.question.offeredAnswers||(t.question.offeredAnswers=[])),"radio"!=t.question.type&&(i(),e(function(){t.question.pageFlowModifier=!1})),"radio"!=t.question.type&&"checkbox"!=t.question.type&&delete t.question.offeredAnswers,"grid"!=t.question.type&&delete t.question.grid,"priority"!=t.question.type&&delete t.question.priorityList},t.pageFlowModifierChanged=function(){i()}}],link:function(e,o,r,n){var i=e.ctrl;i.possiblePageFlow=n.possiblePageFlow}}});
