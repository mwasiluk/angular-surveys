...
angular.module("mwFormBuilder").service("mwFormUuid",function(){function r(){return Math.floor(65536*(1+Math.random())).toString(16).substring(1)}this.get=function(){return r()+r()+r()+r()+r()+r()+r()+r()}}).factory("mwFormClone",["mwFormUuid",function(r){function n(e,t){if(t&&(a=[]),!(a.indexOf(e)>=0)&&(a.push(e),!e!==Object(e))){if(Array.isArray(e))return void e.forEach(n);for(var o in e)e.hasOwnProperty(o)&&n(e[o]);if(e.hasOwnProperty("id")){var i=r.get();e.id;e.id=i}}}var e={},a=[];return e.cloneElement=function(r){var e={};return angular.copy(r,e),n(e,!0),e},e.clonePage=function(n){var a={};angular.copy(n,a),a.id=r.get();var t=[];if(Array.isArray(n.elements))for(var o=0;o<n.elements.length;o++)t.push(e.cloneElement(n.elements[o]));return a.elements=t,a},e.cloneForm=function(r){var n={};angular.copy(r,n);var a=[];if(Array.isArray(r.pages))for(var t=0;t<r.pages.length;t++)a.push(e.clonePage(r.pages[t]));return n},e}]);
