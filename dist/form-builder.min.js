...
angular.module("mwFormBuilder").directive("mwFormBuilder",["$filter",function(a){return{replace:!0,restrict:"AE",scope:{formData:"=",readOnly:"=?",options:"=?",formStatus:"=?",confirm:"=",onImageSelection:"&"},templateUrl:"mw-form-builder.html",controllerAs:"ctrl",bindToController:!0,controller:["uuid",function(a){function e(e){return{id:a.get(),number:e,name:null,description:null,elements:[]}}function o(){for(var a=0;a<t.formData.pages.length;a++)t.formData.pages[a].number=a+1}function r(a,e,o){var r=a[e];a.splice(e,1),a.splice(o,0,r)}var t=this;t.formData.pages&&t.formData.pages.length||(t.formData.pages=[],t.formData.pages.push(e(1))),console.log(t.formData),t.addPage=function(){t.formData.pages.push(e(t.formData.pages.length+1))},t.addPageAfter=function(a){var r=t.formData.pages.indexOf(a),n=r+1,l=e(a.number+1);n<t.formData.pages.length?t.formData.pages.splice(n,0,l):t.formData.pages.push(l),o()},t.moveDownPage=function(a){var e=t.formData.pages.indexOf(a),n=e+1;n<t.formData.pages.length&&r(t.formData.pages,e,n),o()},t.moveUpPage=function(a){var e=t.formData.pages.indexOf(a),n=e-1;n>=0&&r(t.formData.pages,e,n),o()},t.removePage=function(a){var e=t.formData.pages.indexOf(a);t.formData.pages.splice(e,1),o()}}],link:function(e,o,r){var t=e.ctrl,n=a("translate");t.formStatus.form=t.form,t.possiblePageFlow=[],e.$watch("ctrl.formData.pages.length",function(a,e){t.possiblePageFlow.length=0,t.formData.pages.forEach(function(a){t.possiblePageFlow.push({page:{id:a.id},label:n("mwForm.pageFlow.goToPage",{page:a.number})})}),t.possiblePageFlow.push({formSubmit:!0,label:n("mwForm.pageFlow.submitForm")}),t.formData.pages.forEach(function(a){t.possiblePageFlow.forEach(function(e){a.pageFlow&&(e.page&&a.pageFlow.page&&e.page.id==a.pageFlow.page.id||e.formSubmit&&a.pageFlow.formSubmit)&&(a.pageFlow=e),a.elements.forEach(function(a){var o=a.question;o&&o.pageFlowModifier&&o.offeredAnswers.forEach(function(a){a.pageFlow&&(e.page&&a.pageFlow.page&&e.page.id==a.pageFlow.page.id||e.formSubmit&&a.pageFlow.formSubmit)&&(a.pageFlow=e)})})})})})}}}]);
