...
angular.module('mwFormViewer').factory("FormQuestionId", function(){
    ...
    return {
        ...
        controllerAs: 'ctrl',
        bindToController: true,
        controller: ["$timeout", "FormQuestionId", "uuid", function($timeout,FormQuestionId, uuid){
            var ctrl = this;
